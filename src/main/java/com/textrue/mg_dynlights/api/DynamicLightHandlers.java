...
package com.textrue.mg_dynlights.api;
...
public final class DynamicLightHandlers
{
    ...
    public static void registerDefaultHandlers()
    {
        ...
        registerDynamicLightHandler(EntityType.ITEM, entity -> MgDynamicLights.getLuminanceFromItemStack(entity.getItem(), entity.isUnderWater()));
        registerDynamicLightHandler(EntityType.ITEM_FRAME, entity -> {
            World world = entity.getCommandSenderWorld();
            return MgDynamicLights.getLuminanceFromItemStack(entity.getItem(), !world.getFluidState(entity.blockPosition()).isEmpty());
        });
