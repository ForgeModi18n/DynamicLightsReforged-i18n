...
package com.textrue.rb_dynlights.api;
...
public final class DynamicLightHandlers
{
    ...
    public static void registerDefaultHandlers()
    {
        ...
        registerDynamicLightHandler(EntityType.ITEM, entity -> RbDynamicLights.getLuminanceFromItemStack(entity.getItem(), entity.isUnderWater()));
        registerDynamicLightHandler(EntityType.ITEM_FRAME, entity -> {
            World world = entity.getCommandSenderWorld();
            return RbDynamicLights.getLuminanceFromItemStack(entity.getItem(), !world.getFluidState(entity.blockPosition()).isEmpty());
        });
